...
import sys
import os
sys.path.append(r"C:\Users\CUE-ML\shaun\Python\Self-supervised-volumetric-detection\V2")
...
def setup_dataloaders(training_data, validation_data, test_data):    
    ...
    train_dataloader= DataLoader(
        CleanDataset(data=training_data, transforms=None, label='Train', stride=32),#try 32, 16, 8, 4
...
base_dir = r'C:\Users\CUE-ML\vedran\data'
...
test_arrays = [np.load(r'C:/Users/CUE-ML/vedran/data/ID010/ID010_hilbert.npy')]
